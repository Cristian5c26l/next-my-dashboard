...
const getPokemon = async (id: string): Promise<Pokemon> => {
  try {
    ...
    console.log(error);
    notFound();// Mostrar en la URL actual (que por ejemplo seria http://localhost:3000/dashboard/pokemon/idQueNoExiste) el componente NotFound de src/app/not-found.tsx
  }
};
