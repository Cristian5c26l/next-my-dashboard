        ...
        >
            ...
            <div id="profile" className="px-6 py-10">
                ...
                <a href="#" className="inline-flex space-x-2 items-center">
                    ...
                    <span className="text-sm md:text-base font-bold">Cristian Hernandez</span>
                </a>
            </div>
            <div id="nav" className="w-full px-6">

                {/* {
                    menuItems.map((item) => (<SidebarMenuItem key={item.path} path={item.path} icon={item.icon} title={item.title} subtitle={item.subtitle} />))
                } */}
